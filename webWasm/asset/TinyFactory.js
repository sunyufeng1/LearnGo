...
var GLOBAL_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 878800
    , DYNAMICTOP_PTR = 878624;
    ;


var wasmMaximumMemory = 67108864;
...
assert((6121680) % 16 === 0, 'heap must start aligned to 16 bytes, DYNAMIC_BASE==' + 6121680);
assert(67108864 >= TOTAL_STACK, 'TOTAL_MEMORY should be larger than TOTAL_STACK, was ' + 67108864 + '! (TOTAL_STACK=' + TOTAL_STACK + ')');
assert(67108864 % WASM_PAGE_SIZE === 0);
assert(buffer.byteLength === 67108864);
...
var HEAPF64 = new Float64Array(buffer);
  ...
  HEAP32[DYNAMICTOP_PTR>>2] = 6121680;
...
// {{PRE_LIBRARY}}
  ...
  var _fetch_work_queue=878784;function __emscripten_get_fetch_work_queue() {
...
var _malloc,_free,_main,_BGFXCB_Init,_BGFXCB_Lock,_BGFXCB_UnlockAndClear,_init_html,_shutdown_html,_time_html,_RegisterSendMessage,_GetOrCreateSharedMemory,_unsafeutility_malloc,_unsafeutility_memcpy,_unsafeutility_assertheap,_unsafeutility_free,_unsafeutility_memset,_unsafeutility_memclear,_unsafeutility_memcpystride,_unsafeutility_memcmp,_unsafeutility_memcpyreplicate,_unsafeutility_memmove,_unsafeutility_freetemp,_unsafeutility_call_p,_unsafeutility_call_pi,_unsafeutility_get_last_free_ptr,_rafcallbackinit_html,_Decompress_LZ4,_GetStatus,_Close,_GetData,_RequestAsyncRead,_strlen,_BGFXCB_DeInit,_SendMessage,_Time_GetTicksMicrosecondsMonotonic,_CompressBound_LZ4,_Compress_LZ4,_GetErrorStatus,_htonl,_htons,_ntohs,___cxa_demangle,_memalign,_emscripten_builtin_free,_emscripten_builtin_memalign,___set_stack_limit,stackSave,stackAlloc,stackRestore,__growWasmMemory,dynCall_viii,dynCall_viiiii,dynCall_viiiiii,dynCall_vi,dynCall_iii,dynCall_ii,dynCall_iiii,dynCall_iiiiii,dynCall_iiiiiii,dynCall_iij,dynCall_iif,dynCall_iid,dynCall_vii,dynCall_iiiii,dynCall_viiiiiii,dynCall_iiiiiiiii,dynCall_viiii,dynCall_viiiiiiii,dynCall_viiiiiiiiii,dynCall_ji,dynCall_fi,dynCall_v,dynCall_viiiiiiiii,dynCall_i,dynCall_vijii,dynCall_iijii,dynCall_jiji,dynCall_iiiiji,dynCall_idi,dynCall_iidiiii,dynCall_vffff,dynCall_vf,dynCall_vff,dynCall_vfi,dynCall_viif,dynCall_vif,dynCall_viff,dynCall_vifff,dynCall_viffff,dynCall_viiiiiiiiiii,dynCall_viifi;
...
_unsafeutility_get_last_free_ptr = asm["unsafeutility_get_last_free_ptr"];
...
_emscripten_builtin_free = asm["emscripten_builtin_free"];
